...
wardenComplaintRouter.get("http://localhost:8000/api/v1/warden/complaint/", async (req, res) => {
...
wardenComplaintRouter.patch("http://localhost:8000/api/v1/warden/complaint/accept//accept/:id", async (req, res) => {
  const { block } = req.user;
...
wardenComplaintRouter.patch("http://localhost:8000/api/v1/warden/complaint/reject/:id", async (req, res) => {
  const { block } = req.user;
