...
wardenMessRouter.get("http://localhost:8000/api/v1/warden/mess-details/", async (req, res) => {
...
wardenMessRouter.patch("http://localhost:8000/api/v1/warden/mess-details/accept/:id", async (req, res) => {
  const { block } = req.user;
...
wardenMessRouter.patch("http://localhost:8000/api/v1/warden/mess-details/reject/:id", async (req, res) => {
  const { block } = req.user;
