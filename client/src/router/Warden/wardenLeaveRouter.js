...
wardenLeaveRouter.get("http://localhost:8000/api/v1/warden/leave/", async (req, res) => {
...
wardenLeaveRouter.patch("http://localhost:8000/api/v1/warden/leave/accept/:id", async (req, res) => {
  const { block } = req.user;
...
wardenLeaveRouter.patch("http://localhost:8000/api/v1/warden/leave/reject/:id", async (req, res) => {
  const { block } = req.user;
