...
wardenStudentRouter.get("http://localhost:8000/api/v1/warden/student/", async (req, res) => {
...
wardenStudentRouter.get("http://localhost:8000/api/v1/warden/student/:id", async (req, res) => {
  const { block } = req.user;
  const { id } = req.params;
