...
studentEventRouter.post("http://localhost:8000/api/v1/student/event/", async (req, res) => {
  const { id } = req.user;
  const {
    eventName,
    eventDescription,
...
studentEventRouter.get("http://localhost:8000/api/v1/student/event/", async (req, res) => {
  try {
