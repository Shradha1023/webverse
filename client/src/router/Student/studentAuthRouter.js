...
// Error: { message, error }
studentAuthRouter.post("http://localhost:8000/api/v1/student/auth/register", async (req, res) => {
...
// Error: { message, error }
studentAuthRouter.post("http://localhost:8000/api/v1/student/auth/login", async (req, res) => {
