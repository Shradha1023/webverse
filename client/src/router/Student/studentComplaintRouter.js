...
studentComplaintRouter.get("http://localhost:8000/api/v1/student/complaint/", async (req, res) => {
  const { id } = req.user;
...
// Returns: Complaint
// Error: {message: string, error: any}
studentComplaintRouter.post("http://localhost:8000/api/v1/student/complaint/", async (req, res) => {
  const { id } = req.user;
  const {
    complaintType,
    complaintDate,
...
// Error: {message: string, error: any}
studentComplaintRouter.put("http://localhost:8000/api/v1/student/complaint/", async (req, res) => {
  const { id } = req.user;
  const {
    complaintId,
    complaintType,
