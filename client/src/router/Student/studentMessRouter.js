...
studentMessRouter.get("http://localhost:8000/api/v1/student/mess-details/", async (req, res) => {
  const { id } = req.user;
...
studentMessRouter.put("http://localhost:8000/api/v1/student/mess-details/", async (req, res) => {
  const { id } = req.user;
