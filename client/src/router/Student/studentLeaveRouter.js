...
studentLeaveRouter.get("http://localhost:8000/api/v1/student/leave/", async (req, res) => {
  const { id } = req.user;
...
// Returns: Leave
// Error: {message: string, error: any}
studentLeaveRouter.post("http://localhost:8000/api/v1/student/leave/", async (req, res) => {
  const { id } = req.user;
...
// Error: {message: string, error: any}
studentLeaveRouter.put("http://localhost:8000/api/v1/student/leave/", async (req, res) => {
  const { id } = req.user;
...
// Error: {message: string, error: any}
studentLeaveRouter.delete("http://localhost:8000/api/v1/student/leave/", async (req, res) => {
  const { id } = req.user;
