...
studentInfoRouter.get("http://localhost:8000/api/v1/student/me/", async (req, res) => {
  const { id } = req.user;
...
studentInfoRouter.get("http://localhost:8000/api/v1/student/me/my-warden", async (req, res) => {
