...
studentCourseRouter.get("http://localhost:8000/api/v1/student/course/get-all-registered", async (req, res) => {
  try {
    const { id } = req.user;
...
studentCourseRouter.get("http://localhost:8000/api/v1/student/course/get-all", async (req, res) => {
  try {
    /* #swagger.responses[200] = {
           description: 'User successfully obtained.',
           schema: {
...
studentCourseRouter.post("http://localhost:8000/api/v1/student/course/add-course", async (req, res) => {
